...
export const RandomCoffeeSection: React.FC = () => {
  ...
  return (
    ...
    >
      <CoffeeHeader>
        <Title id="coffee-title">
          Рандом-кофе с сотрудником
        </Title>
        {!isConfirmed && (
          <Description id="coffee-description">
            Запишись на 10-минутную онлайн-встречу с сотрудником МТС. 
            Получи баллы и узнай больше о корпоративной культуре из первых уст.
          </Description>
        )}
      </CoffeeHeader>
      ...
      {isLoading ? (
        ...
        <ConfirmationCard>
          ...
          <ConfirmationDetails>
            Ваша встреча с сотрудником МТС успешно забронирована.
            На вашу почту придет письмо со ссылкой на встречу.
          </ConfirmationDetails>
          
          <ConfirmationEmployee>
            <ConfirmationEmployeeName>{selectedEmployee.name}</ConfirmationEmployeeName>
            <ConfirmationEmployeePosition>{selectedEmployee.position}</ConfirmationEmployeePosition>
          </ConfirmationEmployee>
          
          <ConfirmationDetails>
            <strong>Время встречи:</strong> {selectedSlot.day}, {selectedSlot.date} в {selectedSlot.time}
          </ConfirmationDetails>
        ...
        <>
          <EmployeeSection>
            ...
            >
              ...
              <EmployeeDescription>{employees[0]?.description}</EmployeeDescription>
            </EmployeeCard>
          </EmployeeSection>
