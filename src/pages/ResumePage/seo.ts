export const resumePageSEO = {
  ...
  description: "Создай резюме, которое заметят: проверенные рекомендации, реальные примеры, проверка ИИ и лайфхаки от HR-экспертов МТС для успешного старта карьеры.",
